...
public class MainService extends Service {
    ...
    public static final String OPERATION = "ifshow";
    ...
    private List<ActivityManager.RunningTaskInfo> homeList;
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        int operation = OPERATION_HIDE;
        if(intent != null){
            operation = intent.getIntExtra(OPERATION, OPERATION_SHOW);
        }
        switch(operation) {
            case OPERATION_SHOW:
